...
public abstract class Test {
    ...
    public static boolean initElevator(Control control, int elevator, int[] servedFloors, int maxCapacity, int maxWeight, int doorSpeed, int moveSpeed, int initialFloor) {
